...
public class SchedulerSimulation {
    ...
    public static void main(String[] args) {
        ...
        int studentID = 445052792; // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
        ...
        // List to keep track of all created processes for the final summary
        ...
        for (int i = 1; i <= numProcesses; i++) {
            ...
            int randomPriority = random.nextInt(5) + 1; // Generate random priority between 1 and 5

            // Create a new process object with a unique name, burst time, the defined time
            // quantum, and priority
            Process process = new Process("P" + i, burstTime, timeQuantum, randomPriority);

            // Add the process to the ready queue and the map
            addProcessToQueue(process, processQueue, processMap);
            allProcesses.add(process); // Add to our list for final summary
        }
        ...
        while (!processQueue.isEmpty()) {
            ...
            if (!process.isFinished()) {
                ...
                if (!processQueue.isEmpty()) {
                    ...
                    process.setCompletionTime(System.currentTimeMillis()); // Record completion time
                }
            } else {
                process.setCompletionTime(System.currentTimeMillis()); // Record completion time
            }
